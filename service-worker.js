const CACHE_NAME = 'math-snake-game-v12';
const urlsToCache = [
    '/SnakeMeetsMath/',
    '/SnakeMeetsMath/index.html',
    '/SnakeMeetsMath/style.css',
    '/SnakeMeetsMath/script.js',
    '/SnakeMeetsMath/manifest.json',
    '/SnakeMeetsMath/offline.html',
    '/SnakeMeetsMath/icons/icon-192x192.png',
    '/SnakeMeetsMath/icons/icon-512x512.png',
                    ...
                    return fetch(event.request)
                        ...
                        .catch(() => {
                            ...
                            if (event.request.mode === 'navigate') {
                                return caches.match('/SnakeMeetsMath/offline.html');
                            }
