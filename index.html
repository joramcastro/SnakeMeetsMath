...
<body>
    <div class="main-wrapper"> <div class="main-content-wrapper">
            <div class="game-panel">
                ...
                <div class="operation-selection-panel" id="operation-selection-panel">
                    ...
                    <details open> <summary class="operation-category-summary">Decimal Basic Arithmetic</summary>
                        <div class="operation-buttons">
                            <button class="btn operation-btn" data-operation-type="decimal-addition">Addition</button>
                            <button class="btn operation-btn" data-operation-type="decimal-subtraction">Subtraction</button>
                            <button class="btn operation-btn" data-operation-type="decimal-multiplication">Multiplication</button>
                            <button class="btn operation-btn" data-operation-type="decimal-division">Division</button>
                        </div>
                    </details>

                    <details> <summary class="operation-category-summary">Decimal Advanced Arithmetic</summary>
                        <div class="operation-buttons">
                    ...
                    <details>
                        ...
                        <div class="operation-buttons">
                            ...
                            <button class="btn operation-btn" data-operation-type="binary-subtraction">Binary Subtraction</button>
                            <button class="btn operation-btn" data-operation-type="binary-multiplication">Binary Multiplication</button>
                            <button class="btn operation-btn" data-operation-type="binary-division">Binary Division</button>
                        </div>
                    </details>
    ...
    <div id="infoModal" class="modal" style="display:none;">
        <div class="modal-content">
            ...
            <p id="developer-info-text">Developed by: SnakeMeetsMath Team</p>
    ...
    <div id="cheatSheetModal" class="modal" style="display:none;">
        <div class="modal-content cheat-sheet-modal-content">
            <h2 class="font-press-start-2p">Cheat Sheet</h2>
            <div id="cheatSheetContent" class="cheat-sheet-content">
                </div>
            <button id="closeCheatSheetBtn" class="btn">Got It! Start Game</button>
        </div>
    </div>
